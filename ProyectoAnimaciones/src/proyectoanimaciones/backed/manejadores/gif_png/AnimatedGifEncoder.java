package proyectoanimaciones.backed.manejadores.gif_png;
...
public class AnimatedGifEncoder {
  ...
  protected Color background = null;  // background color if given
	 ...
	 *
	 * @param c Color to be treated as transparent on display.
         * @param exactMatch Bandera para indicar si estransparente
	 */
  ...
  public void setBackground(Color c) {
	...
	/**
	 * @return Flushes any pending data and closes output file.
	...
	/**
         * @param c Color Final 
	 * @return Returns index of palette color closest to c
	 *
         * 
	 */
    ...
    /**
     * @param c Color
     * @return Returns index of palette exactly matching to color c or -1 if there is no exact matching.
     *
     *  
     */
	 ...
	 * Writes Graphic Control Extension
         * @throws java.io.IOException Excepcion si no encuetra la ruta
	 */
	 ...
	 * Writes Image Descriptor
         * @throws java.io.IOException Si no encuentra la ruta
	 */
	 ...
	 * Writes Logical Screen Descriptor
         * @throws java.io.IOException No encuentra la ruta
	 */
	...
	/**
	 * @param value Write 16-bit value to output stream, LSB first
         * @throws java.io.IOException No encuentra la ruta
	 */
	...
	/**
	 * 
         * @param s Writes string to output stream
         * @throws java.io.IOException No encuentra la ruta
	 */
